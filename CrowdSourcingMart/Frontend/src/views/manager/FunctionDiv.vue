    ...
    <div class="functiondiv_content">
      ...
      <div class='typora-export'>
        <div id='write' class='is-mac show-fences-line-number' style="width: 100%">
          ...
          <p>双击左侧的任一功能</p>
          <h3>2.填写事务功能</h3>
          <p>根据用户提供等信息F，填写EI、EO、EQ等相关信息</p>
            <h3>2.填写数据功能</h3>
    ...
    data: function () {
      return {
        ...
        columns1: [
          ...
          {
            field: 'transactionType', title: '类型', width: 20, titleAlign: 'center', columnAlign: 'center', isEdit: true,
            isResize: true
          },
          {
          ...
          {
            field: 'fileNum', title: 'FTR数量', width: 25, titleAlign: 'center', columnAlign: 'center', isEdit: false,
            isResize: true
          },
          {
            field: 'DET', title: 'DET', width: 150, titleAlign: 'center', columnAlign: 'center', isEdit: true,
            isResize: true
          },
          {
            field: 'detNum', title: 'DET数量', width: 25, titleAlign: 'center', columnAlign: 'center', isEdit: false,
            isResize: true
          },
          {
            field: 'complex', title: '复杂度', width: 25, titleAlign: 'center', columnAlign: 'center', isEdit: false,
            isResize: true
          },
          {
            field: 'ufp', title: 'UFP', width: 20, titleAlign: 'center', columnAlign: 'center', isEdit: false,
            isResize: true
          },

          {field: 'custome-adv', title: '',width: 35, titleAlign: 'center',columnAlign:'center',componentName:'table-operation',isResize:true}
        ...
        columns2: [
          {
            field: 'name', title: '文件名称', width: 60, titleAlign: 'center', columnAlign: 'center', isEdit: true,
            isResize: true
          },
          {
            field: 'fileType', title: '类型', width: 20, titleAlign: 'center', columnAlign: 'center', isEdit: true,
            isResize: true
          },
          {
          ...
          {
            field: 'retNum', title: 'RET数量', width: 25, titleAlign: 'center', columnAlign: 'center', isEdit: false,
            isResize: true
          },
          {
            field: 'DET', title: 'DET', width: 150, titleAlign: 'center', columnAlign: 'center', isEdit: true,
