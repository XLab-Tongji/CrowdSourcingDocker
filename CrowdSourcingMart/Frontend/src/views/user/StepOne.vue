      ...
      <div class="stepone_content" style="   background: #FFFFFF;">
        <el-form class="stepone_form"  v-model="form" status-icon  ref="form" :rules="rules" label-position="left" label-width="100px" :model="form">
          ...
          <el-form-item style="margin-top:50px">
            <el-button v-on:click="toReport('form')" id="backbtn">返回</el-button>
            <el-button type="primary" v-on:click="toStepTwo('form')" style="margin-right: 10%" id="nextbtn">下一步</el-button>
          </el-form-item>
        </el-form>
      ...
      return {
        ...
        rules: {
          ...
          projectContact: [
            ...
            {min: 5, max: 55, message: '长度在 1 到 20 个字符', trigger: 'blur'}
          ],
          estimationMethod: [
