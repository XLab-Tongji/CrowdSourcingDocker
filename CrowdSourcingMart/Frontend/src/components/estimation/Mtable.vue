          ...
          <el-table-column align="center" label="操作" width="180">
            <template slot-scope="scope">
              <!-- <el-button type="text" size="small" @click="edit(scope.$index, scope.row)">编辑</el-button>-->
               <el-button v-show="scope.row.state ==='完成'" type="text"  size="small" :id=" 'rep' +scope.$index" @click.native.prevent="goReport(scope.$index)">查看报告</el-button>
               <el-button v-show="scope.row.state ==='待审核'" type="text" size="small" :id=" 'est' +scope.$index" @click.native.prevent="goEst(scope.$index)">估算</el-button>
             </template>
           </el-table-column>
