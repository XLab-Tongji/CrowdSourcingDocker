    ...
    <div class="container-list">
      <div class="filter" style="background: #FFFFFF;">
        <div class="search" >
          ...
          <div id="selectDate" ref="selectDate" style="display: none" >
            <el-date-picker
                    type="date"
                    v-model="sTime"
                    @change="getSTime"
        ...
        <div class="create" >
          <el-button  type="primary"  @click="goCreate" id="createBtn">创建估算<i class="el-icon-plus"></i></el-button>
        </div>
      </div>
      <div class="box" style="background: #FFFFFF;">
        <div class="table">
          <el-table  ref="vtable" :data="tableData4" align="center" style="width: 100%;margin: auto;max-width: 960px" height=400>
            ...
            <el-table-column align="center" label="操作" width="180">
              <template slot-scope="scope">
                <el-button @click.native.prevent="deleteRow(scope.$index, tableData4)" type="text" size="small" :id="'removebtn'+scope.$index">移除</el-button>
                <el-button v-show="scope.row.state ==='待修改'" id="testtest" @click.native.prevent="modify(scope.$index)" type="text" size="small" :id="'modifybtn'+scope.$index">修改</el-button>
                <el-button v-show="scope.row.state==='完成'" type="text" size="small" @click.native.prevent="goReport(scope.$index)" :id="'reportbtn'+scope.$index">查看报告</el-button>
              </template>
            </el-table-column>
...
//              global_.ID=this.tableData4[index].rId
        ...
        goCreate:function () {
          this.$http.get(this.url + '/addRequirement',{headers: {Authorization : this.$store.state.user.tokenid}}).then(response => {
